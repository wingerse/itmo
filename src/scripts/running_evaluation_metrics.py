...
def main():
    test_image_hdr = load_hdr_image("C:/Users/ASus/Documents/Final Year Project/latest fyp codes 5-01-21/fyp/test_images/generated_hdr.hdr")
    # test_image_hdr = load_hdr_image("test_images/generated_hdr.hdr")
    test_image_hdr_luminance = luminance(test_image_hdr)


    reference_image_hdr = load_hdr_image('C:/Users/ASus/Documents/Final Year Project/latest fyp codes 5-01-21/fyp/test_images/gt_hdr.hdr')
